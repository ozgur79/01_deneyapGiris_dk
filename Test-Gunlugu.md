...
| dk0130_hizliLed | 2026-09-25 | evet (Özgür) | evet (Özgür) | Test sırasında `.ino`'da SEN YAP adımı denenmiş, loop()'taki iki `delay()` 500'den 50'ye kalmıştı; yorumlarla ve ders.md'nin anlattığı ilk hâlle uyuşmadığı için Özgür 500'e geri aldı. | Özgür kartta test etti, onayladı; kod ilk hâline (delay 500, saniyede 1 kez) döndürüldü. |
| dk0140_karaSimsek | 2026-09-25 | evet (Özgür) | evet (Özgür) | — | ak0060 kaynağından uyarlandı, dört LED D5/D6/D9/D10'da (D5/D6 Ders 1.4'ten devam). Özgür kartta test etti, onayladı. |
| dk0150_trafikLambasi | 2026-09-25 | evet (Özgür) | evet (Özgür) | — | ak0070 kaynağından uyarlandı, üç LED D5/D6/D9'da (D5/D6 Ders 1.4'ten devam). Özgür kartta test etti, onayladı. |
| dk0160_trafikLambasiYazsin | 2026-09-25 | evet (Özgür) | evet (Özgür) | — | ak0115 kaynağından uyarlandı (harcama dersi), dk0150 kodunun üstüne Serial.println eklendi, devre değişmedi (D5/D6/D9), seri hız 115200. Özgür kartta test etti, onayladı. |
